...
export default function LobbyScreen({ modes, onOpenFriends, onViewChange, onOpenBattlePass }: LobbyScreenProps) {
  ...
  return (
    <div className="flex h-full w-full overflow-hidden">
        ...
        {modes.map((mode) => {
          ...
          return (
            <motion.button
              key={mode.id}
              onClick={() => {
                if (isStore) { onViewChange('store'); }
                else { setSelected(mode.id as ModeId); setSlideIdx(0); }
              }}
              ...
              style={{
                ...
                boxShadow: isActive
                  ...
                  : isStore
                    ? '0 8px 32px rgba(0,0,0,0.85), 0 0 18px rgba(251,191,36,0.22), inset 0 1px 0 rgba(255,255,255,0.14)'
            ...
            >
              ...
              <div className="absolute top-0 inset-x-0 h-px pointer-events-none"
                style={{ background: isActive
                  ...
                  : isStore ? 'linear-gradient(90deg, transparent 5%, rgba(251,191,36,0.45) 25%, rgba(255,230,100,0.65) 50%, rgba(251,191,36,0.35) 75%, transparent 95%)'
              ...
              <span className="font-display text-[21px] leading-none tracking-[0.06em] relative z-10"
                style={{ color: isActive ? mc.accent : isStore ? 'rgba(251,191,36,0.85)' : 'rgba(255,255,255,0.38)', textShadow: isActive ? `0 0 20px ${mc.accent}60` : isStore ? '0 0 16px rgba(251,191,36,0.5)' : 'none' }}>
                {mc.label}
              </span>
      ...
      {/* ── CENTER: Banner + JOGAR ── */}
      <div className="flex-1 flex flex-col items-center justify-center gap-4 relative z-10 px-2">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <motion.button
              ...
              style={{
                width: '292px', padding: '22px 0', borderRadius: '22px',
            ...
            >
              <div className="absolute inset-x-0 top-0 pointer-events-none"
                style={{ height: '54%', borderRadius: '22px 22px 0 0', background: 'linear-gradient(180deg, rgba(255,255,255,0.58) 0%, rgba(255,255,255,0.2) 40%, transparent 100%)' }} />
              ...
              <span className="relative z-10 block text-center font-display leading-none tracking-[0.18em]"
                style={{ fontSize: '40px', color: cfg.btnColor }}>{cfg.btnText}</span>
            </motion.button>
          </motion.div>
        </AnimatePresence>
      </div>
      ...
      <div className="flex flex-col gap-2.5 px-3 py-4 w-[220px] shrink-0 z-10">
        {(() => {
          const glass = {
            ...
            boxShadow: '0 8px 32px rgba(0,0,0,0.85), 0 2px 8px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.14), inset 0 -1px 0 rgba(0,0,0,0.4)',
          };
